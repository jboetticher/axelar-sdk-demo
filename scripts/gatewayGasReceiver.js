...
const getGatewayAddress = (network) => {
    switch (network) {
        case 'ethereum': case 'sepolia': return '0xe432150cce91c13a887f7D836923d5597adD8E31';
...
const getWDEVAddress = (network) => {
    switch (network) {
        case 'ethereum': case 'sepolia': return '0x4B13D583F45Aa01fb2bE18a7AAfE14DE183B1Ac9';
